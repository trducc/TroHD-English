...
public class PhongTro {
    ...
    @Column(name = "co_ban_cong")
private Integer coBanCong = 0; // 1 là có, 0 là không

// Getter và Setter (Bắt buộc phải có để Controller chạy được)
public Integer getCoBanCong() { return coBanCong; }
public void setCoBanCong(Integer coBanCong) { this.coBanCong = coBanCong; }

    // --- GETTER & SETTER (ĐÃ FIX LỖI ĐỎ) ---
